...
public class PosAdapter implements IPosService {
	...
	@Override
	public Result checkIfCreditCardIsValid(CreateAccountRequest createAccountRequest) {
		if (fakePosManager.checkCreditCardInformation(createAccountRequest.getSmsPassword(), createAccountRequest.getCreditCard(),
				createAccountRequest.getValidDate(), createAccountRequest.getCVC())) {
